...
{
    public abstract class DataLabelingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DataLabelingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DataLabelingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DataLabelingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DataLabelingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DataLabelingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DataLabelingDbContext, Task<T>> func)
        {
            T result;
