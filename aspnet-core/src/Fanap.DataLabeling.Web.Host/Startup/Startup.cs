...
using Fanap.DataLabeling.Identity;
...
namespace Fanap.DataLabeling.Web.Host.Startup
{
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<DataLabelingWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint($"/swagger/{_apiVersion}/swagger.json", $"DataLabeling API {_apiVersion}");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Fanap.DataLabeling.Web.Host.wwwroot.swagger.ui.index.html");
