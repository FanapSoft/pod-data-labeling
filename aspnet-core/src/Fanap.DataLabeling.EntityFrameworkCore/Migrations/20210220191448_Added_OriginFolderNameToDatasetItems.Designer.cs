...
namespace Fanap.DataLabeling.Migrations
{
    ...
    [Migration("20210220191448_Added_OriginFolderNameToDatasetItems")]
    partial class Added_OriginFolderNameToDatasetItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Accounting.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ReferenceDataSetId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Authorization.StaticUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Authorization.Users.User", b =>
                {
                    ...
                    b.Property<long>("PodContactId")
                        .HasColumnType("bigint");

                    b.Property<long>("PodUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.AnswerLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("CreditCalculated")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid?>("DeterminedLabelId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("DurationToAnswerInSeconds")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("QuestionObject")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("DeterminedLabelId");

                    b.ToTable("AnswerLogs");
                });

            modelBuilder.Entity("Fanap.DataLabeling.Datasets.AnswerOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.Dataset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("CorrectGoldenAnswerIndex")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ItemsSourcePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("LabelingStatus")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProcessedItemsSourcePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("QuestionSrc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.DatasetItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool?>("ConfirmedGoldenData")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid?>("FinalLabelId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGoldenData")
                        .HasColumnType("bit")
                        .HasMaxLength(1000);
                    ...
                    b.Property<string>("OriginFolderName")
                        .HasColumnType("nvarchar(1000)")
                        .HasMaxLength(1000);
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.DatasetItemLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DatasetItemLabels");
                });

            modelBuilder.Entity("Fanap.DataLabeling.Labels.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Fanap.DataLabeling.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Fanap.DataLabeling.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Accounting.Transaction", b =>
                {
                    ...
                    b.HasOne("Fanap.DataLabeling.Datasets.Dataset", "ReferenceDataSet")
                        .WithMany()
                        .HasForeignKey("ReferenceDataSetId");
                });
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.AnswerLog", b =>
                {
                    ...
                    b.HasOne("Fanap.DataLabeling.Datasets.DatasetItem", "DataSetItem")
                        .WithMany()
                        .HasForeignKey("DataSetItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fanap.DataLabeling.Labels.Label", "DeterminedLabel")
                        .WithMany()
                        .HasForeignKey("DeterminedLabelId");
                });
            ...
            modelBuilder.Entity("Fanap.DataLabeling.Datasets.DatasetItem", b =>
                {
                    ...
                    b.HasOne("Fanap.DataLabeling.Labels.Label", "FinalLabel")
                        .WithMany()
                        .HasForeignKey("FinalLabelId");

                    b.HasOne("Fanap.DataLabeling.Labels.Label", "Label")
                        .WithMany()
